...
Lastly, the system is modular meaning that if at any point it has a malfunction the module can be removed and the gun can be used as normal. 
...
\begin{figure}[H]
    ...
    \caption{Trigger and Cable Lock \cite{devices2013personalized}}
    \label{MechFSD}
\end{figure}
...
{\color[HTML]{595959} Parts for the PCBs} & {\color[HTML]{595959} \$20-50}                                 \\
